define(function(require) {
    ...
    sphTutorialMessages.push("The guided tour is over, hope you enjoyed it!<br /><br />You can keep playing with my muscles.  Click \'next\' to restart the tour or click the WormSim logo to go back to the home page!");
	...
	c302TutorialMessages.push("The guided tour is over, hope you enjoyed it!<br /><br />You can keep exploring my nervous system or click \'next\' to restart the tutorial or click the WormSim logo to go back to the home page!");
