...
public class Application {
	...
	@ResponseBody
	public ModelAndView doSetWormInfo(@ModelAttribute WormInfo wormInfo,
		...
		// TODO: redirect to org.geppetto.frontend if worminfo is set
		// successfully (use bundleContext)
