...
os.system("find " + git_path + "/org.geppetto.frontend/src/main/webapp/less/main.less -type f \( -name '*.js' -or -name '*.css' -or -name '*.less' \) -exec sed -i '' 's/background-color: #000000/background-color: #222222/g' {} \;")
